"""
This is a lazy implementation of the ShoppingList __iter__ method using generator expression
"""
...
class ShoppingList:
    ...
    def __iter__(self):
        return (ingredient for ingredient in re.split(', ', self.ingredient_str))
